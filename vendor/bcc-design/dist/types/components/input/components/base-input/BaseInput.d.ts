...
export declare const BaseInput: React.NamedExoticComponent<{
...
} & Omit<import("../../../form-control").FormControlProps, "children" | "focused" | "filled"> & {
    mask?: import("../mask/InputMask.type").InputMaskProps;
    value?: string;
    defaultValue?: string;
    clear?: boolean;
    focusAfterClear?: boolean;
    type?: "number" | "card" | "email" | "money" | "password" | "tel" | "text";
    onChange?: import("./BaseInput.type").InputOnChangeHandler;
    onClear?: (event: MouseEvent<HTMLButtonElement>) => void;
    onClick?: (event: MouseEvent<HTMLDivElement>) => void;
    onMouseDown?: (event: MouseEvent<HTMLDivElement>) => void;
    showFocus?: boolean;
    onMouseUp?: (event: MouseEvent<HTMLDivElement>) => void;
    FormControlComponent?: React.ElementType<import("../../../form-control").FormControlProps & React.RefAttributes<HTMLDivElement>>;
    dataTestId?: string;
