...
/** Select Props */
type InheritedInputProps = Pick<InputProps, 'clear' | 'focusAfterClear' | 'wrapperProps' | 'fullWidth' | 'error' | 'hint' | 'label' | 'labelType' | 'leftAddon' | 'rightAddon' | 'disabled' | 'placeholder' | 'name' | 'id' | 'aria-label' | 'aria-labelledby'>;
