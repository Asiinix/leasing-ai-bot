...
declare const LayoutContext: import("react").Context<LayoutContext>;
export declare const useLayoutContext: () => LayoutContext;
/**
 * Provider
 * */
...
export declare const LayoutProvider: ({ children, initialMediaQuery }: LayoutProviderProps) => import("react").JSX.Element;
export {};
